...
public class BmiResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intbmi<16)
        {
            ...
            mimageview.setImageResource(R.drawable.skeleton);
        ...
        else if(intbmi<16.9 && intbmi>16)
        {
            ...
            mimageview.setImageResource(R.drawable.over_thin);
            //   mimageview.setBackground(colorDrawable2);
        ...
        else if(intbmi<18.4 && intbmi>17)
        {
            ...
            mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.thin);
            //   mimageview.setBackground(colorDrawable2);
        }
        ...
        else if(intbmi <29.9 && intbmi>25)
        {
            ...
            mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.mid_fat);
            //mimageview.setBackground(colorDrawable2);
        }
        else if(intbmi<34.9 && intbmi>30)
        {
            ...
            mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.over_fat);
            //  mimageview.setBackground(colorDrawable2);
        }
        else
        {
            ...
            mimageview.setImageResource(R.drawable.hungry);
            //  mimageview.setBackground(colorDrawable2);
        }
        ...
        mgotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1=new Intent(getApplicationContext(),BmiHome.class);
